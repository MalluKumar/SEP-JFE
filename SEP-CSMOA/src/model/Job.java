...
public class Job implements Comparable<Job> {
	...
	public Job(String orderNum, String jobPriority, String houseNum1, String street, String suburb, String postcode,
			...
			LocalDateTime endDateAndTime, long idleTime, int travelTimeInSeconds, int lengthInMeters, String points) {
	...
	public String toString() {
		return " Job [Num: " + orderNum + " Job Priority: " + jobPriority + ", Start Date and Time: "
				...
				+ (travelTimeInSeconds / 60) + ", Idle_Time: " + idleTime + ", End Date And Time: " + endDateAndTime + ", Distance In Metres: " +  lengthInMeters
				+ "]";
	}
